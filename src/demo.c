...
{
	indata *indata = generate_input_data(N_POP, POP_SIZE, DATASET_LEN, COMPLEX, TRAINING);
...
#ifdef TESTS_ON
	runtime->in = generate_input_data(N_POP, POP_SIZE, DATASET_LEN, COMPLEX, TESTING);
